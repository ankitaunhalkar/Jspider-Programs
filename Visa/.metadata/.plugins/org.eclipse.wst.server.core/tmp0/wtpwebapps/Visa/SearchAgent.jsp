...
<body>
<table>
<form action="SearchAgent.jsp" >
<input type="text" placeholder="Search Agent" name="search" id="search"><input type="submit" value="Search"></form>
<%
...
String searchquery="select * from agent where fname='"+search+"'";
System.out.println(searchquery);
ResultSet rs=st.executeQuery(searchquery);
while(rs.next())
{
%>
<tr><td>Branch:</td><td><%out.println(rs.getString("branch")); %></td></tr>
...
<tr><td>Agent-Created-Date:</td><td><%out.println(rs.getString("date")); %></td></tr>
<%
}
}%>
</table>
